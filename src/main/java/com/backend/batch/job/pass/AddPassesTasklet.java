...
import com.backend.batch.domain.pass.domain.*;
import com.backend.batch.domain.user.domain.UserGroupMappingEntity;
import com.backend.batch.domain.user.domain.UserGroupMappingRepository;
